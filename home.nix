...
in
{
  ...
  programs.fish = {
    ...
    shellAliases = {
      ...
      # ================================================================
      # MONITOR EXTERNO (HDMI, DP, DVI, USB-C)
      # ================================================================
      # Detecta automaticamente qualquer saída externa (ignora eDP/LVDS)
      hdmi-on  = "${pkgs.bash}/bin/bash ${./scripts/monitor-toggle.sh} on";
      hdmi-off = "${pkgs.bash}/bin/bash ${./scripts/monitor-toggle.sh} off";
      hdmi-t   = "${pkgs.bash}/bin/bash ${./scripts/monitor-toggle.sh}";
